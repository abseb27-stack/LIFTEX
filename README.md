...
<nav class="nav" id="nav">
  ...
  <div class="nav-inner">
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="#top" data-i18n="nav_home">
          Accueil
        </a>
      </li>

      <li>
        <a href="#produits" data-i18n="nav_products">
          Produits
        </a>
      </li>

      <li>
        <a href="#galerie" data-i18n="nav_gallery">
          Réalisations
        </a>
      </li>
      ...
      <li>
        <a href="#apropos" data-i18n="nav_about">
          À propos
        </a>
      </li>
...
<div class="mobile-menu" id="mobileMenu">
  ...
  <a href="#top" onclick="closeMobileMenu()" data-i18n="nav_home">
    Accueil
  </a>

  <a href="#produits" onclick="closeMobileMenu()" data-i18n="nav_products">
    Produits
  </a>

  <a href="#galerie" onclick="closeMobileMenu()" data-i18n="nav_gallery">
    Réalisations
  </a>

  <a href="#services" onclick="closeMobileMenu()" data-i18n="nav_services">
    Services
  </a>

  <a href="#apropos" onclick="closeMobileMenu()" data-i18n="nav_about">
    À propos
  </a>

  <a href="#contact" onclick="closeMobileMenu()" data-i18n="nav_contact">
    Contact
  </a>
...
<header class="hero" id="top">
  ...
  <img
    class="hero-image"
    src="assets/images/door-aluminium-05.jpg"
    alt="Réalisation en aluminium"
    fetchpriority="high"
  ...
  <div class="hero-content">
    ...
    <p
      ...
      data-i18n="hero_sub"
    >
      Fabrication et installation sur mesure.
    </p>
...
<section class="intro">
  ...
  <div class="container reveal">
    ...
    <div
      class="eyebrow"
      data-i18n="intro_eyebrow"
    >
      Savoir-faire
    </div>

    <h2 data-i18n="intro_title">
      Le savoir-faire au service de vos espaces.
    </h2>

    <p data-i18n="intro_text">
      Nous réalisons et installons des solutions en aluminium et PVC adaptées à chaque espace, du résidentiel aux projets sur mesure.
    </p>
...
<section class="featured">
  ...
  <div class="featured-grid reveal">
    ...
    <div class="featured-image">
      ...
      <img
        src="assets/images/kitchen-03.jpg"
    ...
    <div class="featured-text">
      ...
      <h3 data-i18n="featured_title">
        Créations sur mesure
      </h3>

      <p data-i18n="featured_text">
        Chaque réalisation est pensée selon les dimensions et les besoins réels de l'espace, du choix des matériaux à la pose finale.
      </p>

      <a
        class="btn btn-outline"
        href="#galerie"
        data-i18n="featured_button"
      >
...
<section class="products" id="produits">
  ...
  <div class="container">
    ...
    <div class="section-head reveal">
      ...
      <h2 data-i18n="products_title">
        Produits
      </h2>

      <p data-i18n="products_subtitle">
        Une gamme complète en aluminium et PVC, fabriquée et installée sur mesure.
      </p>
  ...
  <div class="product-grid reveal">
    ...
    >
      ...
      <img
        src="assets/images/door-aluminium-01.jpg"
        alt="Fenêtres et portes aluminium"
        loading="lazy"
        onerror="this.style.display='none';"
      >
      ...
      <div class="product-info">
        ...
        <h3 data-i18n="product_aluminium">
          Fenêtres & portes Aluminium
        </h3>
    ...
    >
      ...
      <img
        src="assets/images/door-pvc-01.jpg"
        alt="Fenêtres et portes PVC"
        loading="lazy"
        onerror="this.style.display='none';"
      >
    ...
    <a
      href="#galerie"
      class="product-card"
      onclick="setFilter('douche')"
    >

      <img
        src="assets/images/shower-02.jpg"
        alt="Parois et portes de douche"
        loading="lazy"
        onerror="this.style.display='none';"
      >
      ...
      <div class="product-info">
        ...
        <h3 data-i18n="product_shower">
          Parois & portes de douche
        </h3>
...
<section class="gallery" id="galerie">
  ...
  <div class="container">
    ...
    <div class="section-head reveal">
      ...
      <h2 data-i18n="gallery_title">
        Réalisations
      </h2>

      <p data-i18n="gallery_subtitle">
        Un aperçu de nos fabrications et installations récentes.
      </p>
    ...
    <div class="filters reveal">
      ...
      <button
        type="button"
        class="filter-button"
        data-filter="cuisines"
        onclick="setFilter('cuisines')"
        data-i18n="filter_kitchens"
      >
        Cuisines
      </button>
...
<section class="services" id="services">
  ...
  <div class="container">
    ...
    <div class="section-head reveal">
      ...
      <h2 data-i18n="services_title">
        Services
      </h2>

      <p data-i18n="services_subtitle">
        De la fabrication à la pose, un accompagnement complet.
      </p>
    ...
    <div class="reveal">
      ...
      <div class="service-row">
        ...
        <h3 data-i18n="service1_title">
          Fabrication
        </h3>

        <p data-i18n="service1_text">
          Fabrication d'éléments en aluminium et PVC adaptés à vos dimensions.
        </p>
      ...
      <div class="service-row">
        ...
        <h3 data-i18n="service2_title">
          Solutions Aluminium
        </h3>

        <p data-i18n="service2_text">
          Fenêtres, portes et parois en aluminium, sur mesure.
        </p>
      ...
      <div class="service-row">
        ...
        <h3 data-i18n="service3_title">
          Solutions PVC
        </h3>

        <p data-i18n="service3_text">
          Fenêtres et portes PVC, isolantes et durables.
        </p>
      ...
      <div class="service-row">
        ...
        <h3 data-i18n="service4_title">
          Installation
        </h3>

        <p data-i18n="service4_text">
          Pose soignée directement sur site par l'atelier.
        </p>
      ...
      <div class="service-row">
        ...
        <h3 data-i18n="service5_title">
          Aménagement intérieur
        </h3>

        <p data-i18n="service5_text">
          Cuisines, rangements et parois de douche sur mesure.
        </p>
...
<section class="about" id="apropos">
  ...
  <div class="container about-inner reveal">
    ...
    <h2 data-i18n="about_title">
      Un atelier local. Des réalisations sur mesure.
    </h2>

    <p data-i18n="about_text">
      Spécialisé dans la fabrication et l'installation de solutions en aluminium et PVC, nous adaptons chaque réalisation aux besoins et aux dimensions de votre espace.
    </p>
...
<section class="contact" id="contact">
  ...
  <div class="container reveal">
    ...
    >
      Parlez-nous de votre besoin directement sur WhatsApp.
    </p>
    ...
    <div class="contact-meta">
      ...
      <div class="contact-meta-item">
        ...
        <span data-i18n="phone_label">
          Téléphone
        </span>

        <a href="tel:+213792106924">
          +213 792 10 69 24
        </a>
      ...
      <div class="contact-meta-item">
        ...
        <a
          href="https://www.facebook.com/profile.php?id=61575091777923"
          target="_blank"
          rel="noopener noreferrer"
          data-i18n="facebook_link"
        >
          Voir la page
        </a>
...
/* =========================================================
   IMAGE DATA
   جميع المسارات هنا تطابق ملفات GitHub
========================================================= */
...
const GALLERY = [
  ...
  {
    src: "assets/images/door-aluminium-02.jpg",
    category: "aluminium",
    label: {
      fr: "Porte et fenêtre aluminium",
      ar: "باب ونافذة ألمنيوم",
      en: "Aluminium door and window"
    }
  },

  {
    src: "assets/images/door-aluminium-03.jpg",
    category: "aluminium",
    label: {
      fr: "Porte aluminium vitrée",
      ar: "باب ألمنيوم زجاجي",
      en: "Glazed aluminium door"
    }
  },

  {
    src: "assets/images/door-aluminium-04.jpg",
    category: "aluminium",
    label: {
      fr: "Porte aluminium",
      ar: "باب ألمنيوم",
...

  {
    ...
    category: "aluminium",
    label: {
      fr: "Baie coulissante aluminium",
      ar: "باب منزلق ألمنيوم",
      en: "Aluminium sliding door"
    }
  },

  {
    src: "assets/images/window-aluminium-01.jpg",
    category: "aluminium",
    label: {
      fr: "Fenêtre aluminium à volet",
      ar: "نافذة ألمنيوم بمصراع",
      en: "Aluminium shutter window"
    }
  },

  {
    src: "assets/images/window-aluminium-02.jpg",
    category: "aluminium",
    label: {
      fr: "Fenêtre coulissante aluminium",
      ar: "نافذة ألمنيوم منزلقة",
      en: "Aluminium sliding window"
    }
  },

  {
    ...
    category: "pvc",
    label: {
      fr: "Porte PVC décorative",
      ar: "باب PVC مزخرف",
      en: "Decorative PVC door"
    }
  },

  {
    src: "assets/images/door-pvc-02.jpg",
    category: "pvc",
    label: {
      fr: "Porte PVC vitrée",
      ar: "باب PVC زجاجي",
  ...
  {
    src: "assets/images/window-pvc-01.jpg",
    category: "pvc",
    label: {
      fr: "Fenêtre PVC à deux vantaux",
      ar: "نافذة PVC بمصراعين",
      en: "Twin-panel PVC window"
    }
  },

  {
    src: "assets/images/window-pvc-02.jpg",
    category: "pvc",
    label: {
      fr: "Installation fenêtres PVC",
      ar: "تركيب نوافذ PVC",
      en: "PVC window installation"
    }
  },

  {
    src: "assets/images/window-pvc-03.jpg",
    category: "pvc",
    label: {
      fr: "Fenêtre PVC installée",
      ar: "نافذة PVC مركبة",
      en: "Installed PVC window"
    }
  },
...

  {
    ...
    category: "cuisines",
    label: {
      fr: "Cuisine installée",
      ar: "مطبخ مركب",
      en: "Installed kitchen"
    }
  },

  {
    src: "assets/images/kitchen-04.jpg",
    category: "cuisines",
    label: {
      fr: "Cuisine sur mesure",
      ar: "مطبخ حسب الطلب",
  ...
  {
    src: "assets/images/shower-01.jpg",
    category: "douche",
    label: {
      fr: "Paroi de douche",
      ar: "حاجز دش",
...

  {
    ...
    category: "douche",
    label: {
      fr: "Paroi de douche installée",
      ar: "حاجز دش مركب",
      en: "Installed shower enclosure"
    }
  }
...
function renderGallery() {
  ...
  GALLERY.forEach((item, index) => {
    ...
    image.onerror = function () {
      ...
      galleryItem.style.background = "#cccccc";
    };
...
function setFilter(category) {
  ...
  /*
    إذا تم اختيار الفلتر من بطاقة المنتجات،
    ننتقل إلى المعرض.
  */
...
function changeLightbox(direction) {
  ...
  if (currentLightboxIndex >= GALLERY.length) {
...
function setLanguage(language) {
  ...
  */
  ...
  /*
    العناصر التي تحتاج HTML مثل <br>
  */
  ...
  */
  ...
  document
    ...
    .forEach(button => {
      ...
      button.classList.toggle(
        "active",
        button.dataset.langBtn === language
      );
  ...
  */
  ...
  if (language === "ar") {
    ...
    document.title =
      "نجارة الألمنيوم و PVC | تصنيع وتركيب";

  } else if (language === "en") {

    document.title =
      "Aluminium & PVC Workshop | Fabrication & Installation";

  } else {

    document.title =
      "Menuiserie Aluminium & PVC | Fabrication & Installation";

  }

  /*
    إعادة بناء المعرض حتى تتغير أسماء الصور
  */
